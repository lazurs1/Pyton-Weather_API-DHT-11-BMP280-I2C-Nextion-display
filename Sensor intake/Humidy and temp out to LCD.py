...
def main():
    ...
    while True:
        ...
        if result:
            ...
            #LCD1602.write(0, 0, '!!')
            exec(open('/home/pi/Desktop/Projects/Sensor intake/BMP280test3.py').read())
            #execfile("/home/pi/Desktop/Projects/Sensor intake/BMP280test3.py")
        time.sleep(1)
